...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'OggFile'
        db.create_table('djukebox_oggfile', (
            ('audiofile_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['djukebox.AudioFile'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('djukebox', ['OggFile'])

        # Adding model 'Mp3File'
        db.create_table('djukebox_mp3file', (
            ('audiofile_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['djukebox.AudioFile'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('djukebox', ['Mp3File'])


    def backwards(self, orm):
        
        # Deleting model 'OggFile'
        db.delete_table('djukebox_oggfile')

        # Deleting model 'Mp3File'
        db.delete_table('djukebox_mp3file')
