...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('djukebox_track', 'artist',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['djukebox.Artist'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Track.artist'
        db.delete_column('djukebox_track', 'artist_id')
    ...
    models = {
        ...
        'djukebox.track': {
            ...
            'artist': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['djukebox.Artist']", 'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
