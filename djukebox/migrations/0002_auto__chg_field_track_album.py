...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('djukebox_track', 'album_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['djukebox.Album'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Track.album'
        db.alter_column('djukebox_track', 'album_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['djukebox.Album']))
