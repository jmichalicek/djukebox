...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Track.asset'
        db.delete_column('djukebox_track', 'asset')


    def backwards(self, orm):
        
        # Adding field 'Track.asset'
        db.add_column('djukebox_track', 'asset', self.gf('django.db.models.fields.files.FileField')(default=1, max_length=100), keep_default=False)
