...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Album', fields ['artist', 'user', 'title']
        db.create_unique('djukebox_album', ['artist_id', 'user_id', 'title'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Album', fields ['artist', 'user', 'title']
        db.delete_unique('djukebox_album', ['artist_id', 'user_id', 'title'])
