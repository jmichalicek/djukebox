...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('djukebox_audiofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('track', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['djukebox.Track'])),
            ('file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
        ))
        db.send_create_signal('djukebox', ['AudioFile'])


    def backwards(self, orm):
        
        # Deleting model 'AudioFile'
        db.delete_table('djukebox_audiofile')
